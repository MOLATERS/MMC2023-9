        ...
        for col in range(0, 201):
            ...
            for raw in range(0, 251):
                ...
                if Map.valid_map[raw][col] == 0:
                    ...
                    right_edge = int(right_edge_math//Step) if right_edge_math <= Width else Width-1  # 右位置
                    ...
                    for t in range(0, col):
                        if (road_map[raw][col-t] == 1):
                            left_node_width = Map.get_width_by_raw_and_col(raw, t)
                            ita = (t*Step+left_node_width[1]-left_edge_math) / (left_node_width[0]+left_node_width[1])
                            break
